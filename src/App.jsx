...
import { Box, Typography, Divider, Container, Paper, ThemeProvider, createTheme, CssBaseline, useMediaQuery } from '@mui/material';
      ...
      <Container maxWidth="lg">
        ...
        >
          ...
          >
            ...
            >
              <AutoFixHighIcon sx={{ fontSize: 32, transform: 'rotate(30deg)', filter: 'drop-shadow(0 0 4px rgba(255,255,255,0.6))' }} />
              Flashcard Generator
            </Typography>
            <Typography variant="body1">Upload a PDF and create customized flashcards for effective studying</Typography>
          </Paper>
